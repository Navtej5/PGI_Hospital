...
// function createData(doc,wardadhaar,name , ViewRequest, tog) {
//   return {doc,wardadhaar,name ,ViewRequest, tog};
// }
// var i;
// // var rows = [
...
// }
function createData(docnumber,wardadhaar,name , ViewRequest, tog,stage) {
    return {docnumber,wardadhaar,name ,ViewRequest, tog,stage};
  }
  var i;
            ...
            <TableBody>
              {stableSort(rows, getComparator(order, orderBy))
                ...
                {row.ViewRequest}
                        ...
                        {props.user=="unitman"?
                      <TableCell align="right"><Button color="primary" variant = "contained" onClick={()=>{ row.tog.state = "ReceivedByNurse";
